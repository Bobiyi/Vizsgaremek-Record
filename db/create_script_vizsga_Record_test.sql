create database vizsga_record_test
character set utf8mb4
collate utf8mb4_hungarian_ci;

use vizsga_record_test;
...
grant SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, DROP, INDEX, REFERENCES on vizsga_record_test.* to web_api@localhost;
